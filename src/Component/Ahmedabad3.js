...
function Ahmedabad3() {
    ...
    const getAllNews = async (data) => {
        await axios.get('https://timenews.co.in/wp-json/wp/v2/posts?categories=3&page=3', data).then((res) => {
            setNews1(res.data);
        });
    };
        ...
        <div>
            ...
            <nav aria-label="Page navigation example">
                <ul className="pagination justify-content-center" onSubmit={handleSubmit}>
                    ...
                    <li className="page-item">
                        <NavLink className="page-link" to="/ahmedabad2">
                            2
                        </NavLink>
                    </li>
                    <li className="page-item">
                        <NavLink className="page-link" to="/ahmedabad3">
                            3
                        </NavLink>
                    </li>
                    <li className="page-item">
